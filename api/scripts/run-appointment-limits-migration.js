/**
 * Applies appointment daily limits table.
 * Usage (from api/): npm run migrate:appointment-limits
 */
...
const FILE = '72_appointment_daily_limits.sql';
...
async function run() {
  ...
  try {
    ...
    console.log('✅ Done (appointment daily limits).');
  } catch (error) {
